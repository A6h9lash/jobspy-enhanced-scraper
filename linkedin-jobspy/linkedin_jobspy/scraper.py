"""
LinkedIn JobSpy Scraper

Main LinkedIn job scraper implementation.
"""
...
class LinkedIn(Scraper):
    ...
    def _process_job(
        ...
        # Use a simple remote check since we have a simplified version
        is_remote = self._check_if_remote(title, description, location)
    ...
    def _check_if_remote(self, title: str, description: str, location: Location) -> bool:
        """Simple remote job detection"""
        if not title:
            return False
        ...
        if location and location.city:
            location_lower = location.city.lower()
