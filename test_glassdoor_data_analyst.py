#!/usr/bin/env python3
"""
Test script for Glassdoor Data Analyst job scraping
...
def test_glassdoor_data_analyst():
    """
    Test function to scrape Data Analyst jobs from Glassdoor
    """
    print("=" * 60)
    print("Glassdoor Data Analyst Jobs Test")
    print("=" * 60)
    ...
    try:
        # Perform the search
        print("Starting Glassdoor job search...")
    ...
    print("=" * 60)
    print("Glassdoor test completed!")
    print("=" * 60)
    return True


if __name__ == "__main__":
    success = test_glassdoor_data_analyst()
